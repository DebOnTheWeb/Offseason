...
//     // public void Drive(LinearVelocity forward, double rotation) {
//     //     forward = DriveConstants.kSpeedAt12Volts;
//     //     rotation = DriveConstants.kCoupleRatio;
//     //   }
//   // Swerve Drive Constants in meters
//     public static final Translation2d FRONT_LEFT_LOCATION = new Translation2d(kFrontLeftXPos, kFrontLeftYPos);
//     public static final Translation2d FRONT_RIGHT_LOCATION = new Translation2d(kFrontRightXPos, kFrontRightYPos);
//     public static final Translation2d BACK_LEFT_LOCATION = new Translation2d(kBackLeftXPos, kBackLeftYPos);
//     public static final Translation2d BACK_RIGHT_LOCATION = new Translation2d(kBackRightXPos, kBackRightYPos);
//     //public static final Rotation2d GYRO_OFFSET = null;

//     SwerveDriveKinematics driveKinematics = 
//         new SwerveDriveKinematics(FRONT_LEFT_LOCATION, FRONT_RIGHT_LOCATION,BACK_LEFT_LOCATION,BACK_RIGHT_LOCATION);

//         //vx = m/s forward, vy = m/s left, omegaRadian = m/s clockwise(rotations)
//     ChassisSpeeds speeds = new ChassisSpeeds(12,12,12);//**MUST CHANGE TO FUCKING BIG
//     SwerveModuleState[] moduleStates = Kinematics.SwerveDriveKinematics.toSwerveModuleStates(speeds);
    
//     public SwerveModuleState getState(){
//         double speed = kSpeedAt12Volts.abs(FeetPerSecond);
//         Rotation2d rotation = Rotation2d.fromRotations(kCoupleRatio);
//         return new SwerveModuleState(speed, rotation);
//     }
//     private final SwerveDriveOdometry kinematicsOdometry = SwerveDriveOdometry(driveKinematics, new Rotation2d(), new Pose2d(0, 0, new Rotation2d()));


//     //**POTENTIAL USE
//     // //neutral modes -> determine how motors behave when robot is disabled
...
//     // //modes allow wheels to move forward but not turn when disabled
//     //*Also uses SwerveDriveBrake to set x position
