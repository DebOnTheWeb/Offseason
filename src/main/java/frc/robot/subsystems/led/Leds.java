...
import frc.robot.subsystems.led.patterns.LedPattern;

public class Leds extends SubsystemBase {
    private final AddressableLEDBuffer ledBuffer = new AddressableLEDBuffer(LEDS.LED_STRIP_LENGTH);
    private final AddressableLED strip = new AddressableLED(LEDS.LED_STRIP_PORT_PWM);
    ...
    public Command commandShowOutakePattern(LedPattern pattern) {
        return commandShowFullPattern(pattern, PatternLevel.OUTTAKE_STATE);
    }

    public Command commandShowLatchPattern(LedPattern pattern) {
        return commandShowFullPattern(pattern, PatternLevel.LATCH_STATE);
    }
